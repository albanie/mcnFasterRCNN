function run_faster_rcnn_tests(varargin)
% ------------------------
% run tests for Faster-RCNN module
% (based on vl_testnn)
% ------------------------
...
%suiteDir = fullfile(vl_rootnn, 'contrib', 'mcnFasterRCNN/matlab/xtest/suite') ;
suiteDir = fullfile(vl_rootnn, 'contrib', 'mcnFasterRCNN/matlab/xtest/suite/dev') ;
addpath(suiteDir) ;
